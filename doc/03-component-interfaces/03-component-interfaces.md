...
- **Name**: <!-- TODO: fill with first and last name (e.g., Brutus Buckeye) and delete this comment --> Jeongui Hong
- **Dot Number**: <!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment --> hong.1056
- **Due Date**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->  Thu Oct 23, 2025 1:50pm
...
![BudgetEnvelope Hierarchy Diagram](budgetEnvelopeHierarchy.png)
